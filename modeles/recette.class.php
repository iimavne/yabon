...
class Recette
{
     ...
     *
     * @param integer|null $id l'identifinat de ka rectte 
     * @param string|null $nom nom de la recette 
     * @param string|null $description
     * @param string|null $image
     * @param Categorie|null $categorie la categorie de la rectte : entree plat set dessert 
     ...
     * Undocumented function
     * 
     * @return integer|null l'id de la recette ou null si yen a pas
     */
